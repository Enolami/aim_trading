...
use tasks::{
    ...
    spawn_rsi_task, register_rsi_sort_handler, spawn_ma50_task, register_ma50_sort_handler,
...
async fn main() {
    ...
    let _ma50_task = spawn_ma50_task(&ui).await;
